...
import { Play, TrendingUp, Award, CheckCircle2 } from "lucide-react";
  ...
  return (
    <section className="relative bg-[#FAF9F7] text-stone-900 pt-28 sm:pt-32 lg:pt-36 pb-20 overflow-hidden">
      ...
      <div className="max-w-[1440px] mx-auto px-4 sm:px-6 lg:px-8 w-full relative z-10">
        ...
        {/* ── TOP HERO ROW (LEFT HEADLINE & CTAS + RIGHT PORTRAIT WITH OVERLAYS) ── */}
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-center">
          ...
          <div className="lg:col-span-6 space-y-7 text-left">
            ...
            >
              ...
              >
                ...
                <span>{lang === "bn" ? "প্রসেস দেখুন" : "Watch Overview"}</span>
              </a>
            </motion.div>
          ...
          {/* ── RIGHT COLUMN: FINEDGE Portrait Photo & Floating Data Cards ── */}
          <div className="lg:col-span-6 relative flex justify-center lg:justify-end">
            ...
            {/* Floating Overlay Card 1 (Top Left of Portrait) */}
            <motion.div
              initial={{ opacity: 0, x: -20 }}
              animate={{ opacity: 1, x: 0 }}
              transition={{ ...transition.slow, delay: 0.35 }}
              className="absolute top-10 -left-4 sm:left-4 bg-white rounded-2xl p-4 border border-stone-200 flex items-center gap-3.5 max-w-[240px] z-20"
            >
            ...
            {/* Floating Overlay Card 2 (Bottom Right of Portrait) */}
            <motion.div
              initial={{ opacity: 0, x: 20 }}
              animate={{ opacity: 1, x: 0 }}
              transition={{ ...transition.slow, delay: 0.42 }}
              className="absolute bottom-10 -right-4 sm:right-4 bg-white rounded-2xl p-4 sm:p-5 border border-stone-200 space-y-2 max-w-[260px] z-20"
            >
