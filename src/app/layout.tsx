...
export const metadata: Metadata = {
  ...
  openGraph: {
    title: "Muntajar — Global Mobility Platform",
    description:
      "Bangladesh's trusted digital platform for international education, careers, and migration. Transparent, broker-free, and career-focused.",
    url: "https://muntajar.com",
    siteName: "Muntajar",
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: "Muntajar — Building Global Opportunities",
      },
    ],
    locale: "en_US",
    type: "website",
  ...
  twitter: {
    ...
    title: "Muntajar — Global Mobility Platform",
    description:
      "Bangladesh's trusted digital platform for international education, careers, and migration.",
